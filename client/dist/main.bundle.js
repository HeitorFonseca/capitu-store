...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_10__services_product_service__["a" /* ProductService */]],
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getProducts = function () {
        return this.http.get(this.domain + 'product/').pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["h" /* map */])(function (res) { return res; }));
    };
    // Function to register projects
    ProductService.prototype.registerProduct = function (product, file) {
        ...
        return this.http.post(this.domain + 'product/register', fd, { headers: headers }).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["h" /* map */])(function (res) { return res; }));
    };
    ProductService.prototype.getProductsImgs = function (img) {
        ...
        return this.http.get(this.domain + 'product/estampas/img', { params: params, responseType: "blob" }).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["h" /* map */])(function (res) { return res; }));
    };
    // Function to register projects
    ProductService.prototype.registerOrder = function (order) {
        return this.http.post(this.domain + 'order/register', order).map(function (res) { return res; });
    };
